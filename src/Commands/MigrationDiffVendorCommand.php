...
class MigrationDiffVendorCommand extends AbstractDiffVendorCommand
{
    ...
    /**
     * Override handle to implement custom matching logic for timestamped migrations.
     */
    public function handle(Filesystem $fs): int
    {
        ...
        $vendorFiles = array_filter($allVendorFiles, fn ($file) => ! $this->shouldExcludeVendorFile($file));
